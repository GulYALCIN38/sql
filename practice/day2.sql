...
insert into child values(101,1008,'araba','hasan kaya');

--SORU 2: .child tablosuna ted_verginosu 105 olan veri girişi yapınız.
--insert into child values(105,19,'ay','ak')  105 primary key parent tabloda yok bu yuzden veri girisi child tabloya yapilamaz

--SORU 3: child tablosuna ted_vergino null olan veri girişi yapınız
insert into child values(null,2000,'fare','gul yalcin')-- child tabloya foreign key sutununa null veri girilebilir
...
delete  from child where ted_vergino=101;-- 101 i once child den sonra parent ten silebiliriz

--SORU 7: .parent tablosunu siliniz. -- silinemez once child tablo ssilinmeli
...
--SORU1: parent2 tablosundaki tüm verileri silini

delete from parent2; --on delete cascade sayesinde child tablodaki veriyi silmeden parent tablo daki veriyi sildik
--SORU2: parent2 tablosunu siliniz

drop table parent2 cascade;-- cascade yazdik boylece child ile ugrasmadan parent 2 silindi ama child hala duruyor
...
UPDATE toptancilar
set sirket_ismi='vivibook'where vergi_no=202;
